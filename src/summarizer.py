...
class Summarizer(cm.CommonModule):
    ...
    def main_process(self):
        ...
        self.st.ae_txn_detail_summary_temp_create_table(self.logger)
        self.st.ae_txn_sql_detail_summary_temp_create_table(self.logger)
        self.st.summary_join(self.logger)
