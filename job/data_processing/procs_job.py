...
#%%
class processJob:
    def was_procs_job(self, input_date, input_interval):
        try:
            ...
            for i in range(1,input_interval):
                ...
                endDate_re = from_date+timedelta(days=i) 
                endDate = endDate_re.strftime('%Y-%m-%d 00:00:00')
                ...
                logger.info("Summary 대상 파티션테이블 날짜 : "+ prtitionDate)                
                ...
                for command in commands:           
                    ...
                    logger.info("Temp Select 종료시간 : "+ str(end_tm))            
                    logger.info("Temp Select 수행시간 : "+ str(end_tm - start_tm)+"\n") 
                ...
                logger.info(prtitionDate+" Import 데이터 ae_txn_sql_summary Insert 완료")    
    ...
    def db_procs_job(self, input_date, input_interval):
        try:
            #log 파일을 생성하기 위한 logger 인스턴스 생성
            ...
            for i in range(1,input_interval):
                ...
                # Import Data
                inter_df.to_sql(name = 'ae_db_sql_summary',
                            con = engine,
                            schema = 'public',
                            if_exists = 'append',
                            index = False#,
                ...
                logger.info("Insert 종료시간 : "+ str(end_tm))    
                logger.info("Insert 수행시간 : "+ str(end_tm - start_tm)+"")   
                logger.info(prtitionDate+" Import 데이터 ae_db_sql_summary Insert 완료")    
